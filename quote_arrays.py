...
def get_hymn_quotes():
    ...
    retarr = []
    retarr.append(
        "Every time I watch a grixis player cast hymn and die to combo the following turn I have an unreasonable amount of joy.")
    ...
    retarr.append(
        "Legacy has shifted in a direction where specific cards matter much more than raw quantity. Most of the fair decks have only 4-6 cards that actually matter, so hymn sucks.")
    retarr.append("People cast hymn on turn 2 against combo because they enjoy losing.")
    retarr.append(
        "If you sleeve up your first hymn before your third thoughtseize you're just trying to have an early dinner.")
    ...
    retarr.append(
        "Hymn isn't a threat in your glacially slow control deck. I really hope they don't recover in the 15 more turns they have.")
